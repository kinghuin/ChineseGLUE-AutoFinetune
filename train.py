...
# hyper-parameter, set in hparam.yaml
...
# Parameter used by paddlehub autofinetuner, DO NOT SET THEM
...
def finetune(args):
    ...
    # To accelerate fine tuning, Not eval or save_ckpt during fine tuning.
